...
class Authentication:
    ...
    # defining the constructor for the class which initiates the 'protected' attributes to the values passed to it or to the default values (Unknown)
    def __init__(self, inputUsername="Unknown", inputPassword="Unknown", data_map={"unknown": "unknown"}):
        self.username_ = inputUsername
        self.password_ = inputPassword
